...
********************************************
ROMBEG  EQU     $F804           ; ROM START ASSEMBLY ADDRESS, orig: F804
RAMOFS  EQU     -$9800          ; ROM OFFSET TO RAM WORK PAGE

ROMSIZ  EQU     2044            ; ROM SIZE, orig: 2048
ROM2OF  EQU     ROMBEG-ROMSIZ   ; START OF EXTENSION ROM
ACIA    EQU     $F800           ; DEFAULT ACIA ADDRESS
...
SIGNON  FCC     /AST9/      ; SIGNON EYE-CATCHER
        FCB     EOT
